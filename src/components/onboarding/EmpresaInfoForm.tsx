...
export const EmpresaInfoForm: React.FC<EmpresaInfoFormProps> = ({ form, isMobile }) => {
  return (
    <>
      <FormField
          ...
          <FormItem>
            ...
            <FormControl>
              <div className="flex items-center border rounded-md px-3 py-2">
                ...
                <Input className="border-0 p-0 shadow-none focus-visible:ring-0 text-base" placeholder="Nome da sua startup" {...field} />
              </div>
            </FormControl>
            <FormMessage />
          </FormItem>
      ...
      <div className={`grid ${isMobile ? 'grid-cols-1 gap-4' : 'grid-cols-1 md:grid-cols-2 gap-4'}`}>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-base">Segmento</FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-base">Estágio</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger className="text-base h-11">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-base">Número de funcionários</FormLabel>
              <FormControl>
                <div className="flex items-center border rounded-md px-3 py-2">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-base">Data de fundação</FormLabel>
              <FormControl>
                <div className="flex items-center border rounded-md px-3 py-2">
                  <DatePicker
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="text-base">Website (opcional)</FormLabel>
            <FormControl>
              <div className="flex items-center border rounded-md px-3 py-2">
